...
def hyper_params_analysis():
    ...
    tag = f"quadruple_tank_locs={hyper_params_options['num_locs']}_compr={hyper_params_options['size_after_compr']}_steps={num_time_steps}_w2_p__q={w2_p__q}_w2_noise={w2_noise_dist}"
...
def boundary_cond_analysis():
    ...
    num_locs = 100
    size_after_compr = 5
    tag = f"quadruple_tank_locs={num_locs}_compr={size_after_compr}_steps={num_time_steps}_w2_p__q={hyper_params_options['w2_p__q']}_w2_noise={hyper_params_options['w2_noise_dist']}"
...
if __name__ == '__main__':
    ...
    # hyper_params_analysis()

    boundary_cond_analysis()
